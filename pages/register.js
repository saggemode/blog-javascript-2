      ...
      <div className="container w-full p-4 px-4 lg:px-10 mt-10">
        <Row className="flex flex-col xl:flex-row">
          <Col span={24} xl={10} className="p-4">
            ...
            <div
              className="flex justify-between cursor-pointer mb-4 border items-center p-4"
            ...
            >
              ...
              <h1 className="font-bold text-xl uppercase my-4">
                Login Details
              </h1>
              <Form.Item
                name="email"
          ...
          <Col span={24} xl={10} className="p-4">
            ...
            <h1 className="font-bold text-xl mt-4 uppercase">
              CREATE AN ACCOUNT:
            </h1>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;Simple overview of your personal
              information
            </p>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;Faster checkout
            </p>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;A single global login to interact
              with adidas products and services
            </p>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;Exclusive offers and promotions
            </p>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;Latest products arrivals
            </p>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;New season and limited collections
            </p>
            <p className="mt-3 cursor-pointer flex items-center">
              <CheckOutlined /> &nbsp; &nbsp;Upcoming events
            </p>
          </Col>
        </Row>
      </div>
