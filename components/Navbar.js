  ...
  return (
    <nav className="fixed top-0 z-50 backdrop-blur-lg w-full flex justify-between items-center h-20 px-4 lg:px-10">
      <div className=" flex items-center">
        <Link href="/">
          <h1 className="text-2xl uppercase font-extrabold cursor-pointer mr-2 hidden sm:block">
            theBootStore
          </h1>
        </Link>
        <Link href="/">
      ...
      <div className="flex items-center">
        <Badge count={wishItems.length ? wishItems.length : ""}>
          <h1 className="text-xl font-bold uppercase flex items-center cursor-pointer bg-secondary p-2 sm:px-4 ">
            <HeartOutlined />
        ...
        <Link href="/login">
          <h1 className="text-xl ml-2 font-bold uppercase flex items-center cursor-pointer bg-secondary p-2 sm:px-4 ">
            <UserOutlined /> &nbsp;{" "}
        ...
        {/* {isAuth ? (
          <Dropdown overlay={menu} trigger={["click"]}>
            <h1 className="text-xl ml-2 font-bold uppercase flex items-center cursor-pointer bg-secondary p-2 sm:px-4 ">
              <UserOutlined /> &nbsp;{" "}
              <span className="hidden lg:block">Mukul</span>
            </h1>
          </Dropdown>
        ) : (
          <Link href="/login">
